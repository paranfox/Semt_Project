...
public class UserRegisterOkAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		//String saveFolder = "C:\\Users\\cdecd\\git\\semi_project\\JSP_Semi_Project4\\src\\main\\webapp\\fileUpload";
		...
		int email_certification = Integer.parseInt(multi.getParameter("emailCertification").trim());
