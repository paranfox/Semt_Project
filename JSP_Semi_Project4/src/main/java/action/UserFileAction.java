...
public class UserFileAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		// 1. 첨부 파일 저장 경로 지정.
		String saveFolder = 
				"C:\\NCS\\workspace(user)\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp1\\wtpwebapps\\JSP_Semi_Project4\\fileupload";
		...
		String music_id = multi.getParameter("music_id");
